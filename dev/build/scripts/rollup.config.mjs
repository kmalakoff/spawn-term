...
replacements['export { Box as B, Newline as N, Static as S, Text as T, Transform as a, Spacer as b, useApp as c, useStdin as d, useStdout as e, useStderr as f, getDefaultExportFromCjs as g, useFocus as h, useFocusManager as i, measureElement as m, render as r, useInput as u };'] =
  'export { Box, Newline, Static, Text, Transform, Spacer, useApp, useStdin, useStdout, useStderr, getDefaultExportFromCjs, useFocus, useFocusManager, measureElement, render, useInput };';
